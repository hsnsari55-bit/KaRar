...
export default function App() {
  ...
  const handleRunStep = async (id: PipelineStepId): Promise<string[]> => {
    setIsRunning(true);
    try {
      ...
      setIsRunning(false);
      return [`[ERROR] Failed to run step ${id}: ${err.message}`];
    }
  };
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100 flex flex-col font-sans">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-[10px] text-zinc-400 font-mono uppercase tracking-wider mt-0.5">
                DWG: GÜZELCE 467 ADA 9 PARSEL (23.12.2025)
              </p>
            </div>
          </div>
      ...
      <section className="bg-zinc-900/40 border-b border-zinc-800/80 px-4 py-3">
        <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-3">
          ...
          {/* Floor Level Quick Selector Pills */}
          <div className="col-span-2 md:col-span-4 lg:col-span-1 bg-zinc-900/80 border border-zinc-700/50 rounded-lg p-1.5 flex items-center justify-between gap-1">
            {mockFloors.map((fl) => (
              <button
                key={fl.id}
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto p-4 lg:p-6 grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-8 flex flex-col space-y-4">
          ...
          <div className="transition-all duration-300">
            ...
            {activeTab === "phase2" && (
              <Phase2Panel floor={currentFloor} />
            )}
